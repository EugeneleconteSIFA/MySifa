...
from app.routers.encres import router as encres_router
...
from app.routers.qualite_ged import router as qualite_ged_router
from app.routers.qualite_fsc import router as qualite_fsc_router
...
from app.routers.reunions import router as reunions_api_router
from app.web.reunions_page import router as reunions_page_router
...
app.include_router(encres_router)
...
app.include_router(qualite_ged_router)
app.include_router(qualite_fsc_router)
...
app.include_router(reunions_api_router)
app.include_router(reunions_page_router)
