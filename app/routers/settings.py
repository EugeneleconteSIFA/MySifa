...
def maintenance_alerts_active(request: Request):
    ...
    with get_db() as conn:
        ...
        for r in rows:
            ...
            should_show = False
            if ttype == "periodic":
                # Le gap silence les alertes periodiques
                if gap_active:
                    continue
                ...
                if op_code and user_machine and operateur:
                    ...
                    if last_ack_at_str:
                        ...
                        # Jamais acquitte : on regarde uniquement les saisies
                        # d'aujourd'hui pour eviter de faire remonter des
                        # actions historiques a l'activation de l'alerte.
                        q += " AND date_operation >= ?"
