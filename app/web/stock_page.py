...
var STOCK_GUIDES = {
  ...
  'mystock-controle': { steps: [
    ...
    },
    {
      ...
      body: `<span class="mguide-tag">En cours de développement</span> Le <strong>Monitoring</strong> importera un état ERP et le compare au stock MySifa. Les lignes se classent par <span class="mguide-hl">statut</span> : concordant, écart, ou <span class="mguide-tag">sans correspondance</span>. On traite d'abord les anomalies.`,
