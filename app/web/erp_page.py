...
function urlListe(){
  ...
  // contre les colonnes de l'écran, jamais contre la table. Ils valent pour
  // les deux vues — regrouper par pièce ne doit pas silencieusement rendre un
  // filtre de colonne inopérant.
