...
:root{--accent-bg:rgba(34,211,238,.10);--ok:#34d399;--btn-fg:#0a0e17;--sidebar-w:220px;}
html.light-pre body,body.light{--muted:#64748b;--accent-bg:rgba(8,145,178,.08);--ok:#059669;--btn-fg:#ffffff;}
...
const QUALITE_TASKS_BY_SERVICE = {
  ...
  commercial: {
    ...
    tasks: [
      "Consulter les certifs pour répondre aux appels d'offres",
...
const QUALITE_TASKS_MODULES = {
  ...
  ref: {
    ...
    commercial: {
      ...
      icon: `<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>`,
      tasks: [
        "Consulter les fiches pour répondre aux appels d'offres",
    ...
    'ref-rse': {
      steps: [
        ...
        },
        {
          ...
          title: "Recherche & AO",
          body: "La barre de recherche (raccourci <strong>/</strong>) filtre par nom, acronyme, mot-clé ou catégorie. Utilise le référentiel comme <strong>base de connaissances</strong> quand tu réponds à un appel d'offres — les réponses type sont copiables en un clic."
        },
      ]
    }
  };
