...
def can_access_settings(user: dict) -> bool:
    """L'utilisateur peut ouvrir la page /settings (au moins une section)."""
...
def settings_sections_visibility(user: dict) -> dict:
    """Flags de visibilité par section pour l'UI /settings. Injecté dans le HTML."""
    ...
    return {
        ...
        # Section « Outils » (regroupement Imprimantes + Registre FSC) : uniquement
        # pour les rôles techniques qui n'ont pas les sections complètes Audit /
        # Impression. Direction et superadmin voient ces onglets depuis leurs
        # sections respectives ; ils n'ont pas la carte « Outils ».
